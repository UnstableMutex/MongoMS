...
namespace MongoMS.ViewModel
{
    class DatabaseExplorerCollectionViewModel : DatabaseExplorerTreeItemBase
    {
        ...
        public DatabaseExplorerCollectionViewModel(string name, string cs, string db)
            : base(name, ItemType.Collection)
        {
            _cs = cs;
            _db = db;
        ...
        void Aggregate()
        {
            SimpleIoc.Default.GetInstance<MainViewModel>().Content.Add(new AggregateViewModel(_cs, _db, Name));
        }
    }
}